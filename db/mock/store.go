...
// Source: github.com/danarcheronline/gringotts_wizarding_bank/db/sqlc (interfaces: Store)
...
// IncreaseAccountBalance mocks base method.
func (m *MockStore) IncreaseAccountBalance(arg0 context.Context, arg1 db.IncreaseAccountBalanceParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IncreaseAccountBalance", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// IncreaseAccountBalance indicates an expected call of IncreaseAccountBalance.
func (mr *MockStoreMockRecorder) IncreaseAccountBalance(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IncreaseAccountBalance", reflect.TypeOf((*MockStore)(nil).IncreaseAccountBalance), arg0, arg1)
}
